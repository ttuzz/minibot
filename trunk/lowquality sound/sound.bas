...
'длительности, количество пауз по 20мс
Const Cel = 32                                              ' 1/1
Const Sem = 16                                              ' 1/2
Const Qv = 8                                                ' 1/4
Const D_cr = 6                                              ' 3/16
...
'ноты, загружаются в таймер, определяют частоту колебаний
Const C1 = 17                                               ' 262 -> До
...
Dim C241(101) As Byte                                       'длительность
C241(1) = Sq
C241(2) = Qv
C241(3) = Cr
C241(4) = Cr
...
Sound_1:
   Lang = C241(index)                                       'длительность
   T1reload = C240(index)                                   'нота
